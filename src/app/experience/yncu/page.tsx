      ...
      <Column className="gap-4 rounded-xl border border-white/10 p-6 backdrop-blur-md">
        <Row className="items-center gap-2">
          ...
          <span className="text-lg font-semibold text-white">
            Full Stack Developer I, Full-time{" "}
            <span className="text-sm text-gray-400">(May 2025 - September 2025)</span>
          </span>
        </Row>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>June 2024 - September 2025</span>
        <span className="hidden sm:flex">•</span>
...
const YNCUPage: React.FC = () => {
  ...
  return (
    <PageShell
      breadcrumbs={[{ label: "Experience", href: "/experience" }, { label: "YNCU" }]}
    >
      <YNCUHeader />
          ...
          {projects.map((project) => {
            ...
            return (
              ...
              >
                ...
                >
                  <AccordionTrigger
                    className="group flex items-center gap-3 text-sm font-normal text-white transition hover:text-blue-400 focus:text-blue-400 md:text-base"
                    onClick={openProject}
                  >
